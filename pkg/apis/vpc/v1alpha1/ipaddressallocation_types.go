...
type IPAddressAllocationSpec struct {
	...
	// If set, IP addresses of this allocation will be allocated from this IP Block, instead of the default IP Block associated with the Namespace's primary VPC.
	// +optional
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="Value is immutable"
